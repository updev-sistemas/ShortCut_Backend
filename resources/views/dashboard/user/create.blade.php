            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Novo Administrador</h6>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form method="post" action="{{ route('user.store') }}" role="form" class="text-start">
                                    @csrf
                                    ...
                                    @enderror
                                    <div class="row">
                                        <div class="input-group input-group-outline my-3 @error('email') focused is-focused @enderror">
