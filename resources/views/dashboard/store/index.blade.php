            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        ...
                        <a href="{{ route('store.create') }}" class="btn bg-gradient-dark" style="float:right;margin-top:-40px;margin-right: 20px;">Novo</a>
                    </div>
                </div>
                                    ...
                                    @foreach($collection->sortBy('name') as $key => $target)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                @if ($target->id != 1)
                                                <p class="text-center">
                                                    <a href="{{ route('store.edit',['id' => encrypt($target->id)]) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Editar usuário">Editar</a>
                                                </p>
                                                @endif
                                            </td>
                                        </tr>
